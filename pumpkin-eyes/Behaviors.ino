...
void behaviorLoop() {
  ...
  if (currentTime - lastBehaviorTick >= BEHAVIOR_TICK_INTERVAL) {
    ...
    switch (currentBehavior) {
      ...
      case BEHAVIOR_POST_INVASION:
        handleBehaviorPostInvasion();
        break;
...
String getBehaviorName(EyeBehavior behavior) {
  switch (behavior) {
    ...
    case BEHAVIOR_POST_INVASION: return "POST_INVASION";
...
void initializeBehavior(EyeBehavior behavior) {
  switch (behavior) {
    ...
    case BEHAVIOR_POST_INVASION:
      ...
      initializePostInvasionBehavior();
      break;
...
void changeToRandomBehavior() {
  ...
  do {
    ...
    // Currently IDLE (0), MOUTH_INVASION (8), SLEEPING (9), and POST_INVASION (10) are enabled
    EyeBehavior availableBehaviors[] = {BEHAVIOR_IDLE, BEHAVIOR_MOUTH_INVASION, BEHAVIOR_SLEEPING, BEHAVIOR_POST_INVASION};
    uint8_t randomIndex = random(0, 4); // 0-3
